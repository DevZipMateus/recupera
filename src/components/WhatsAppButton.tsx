...
const WhatsAppButton = () => {
  ...
  const handleWhatsAppClick = () => {
    window.open('https://wa.me/5561986649007?text=Olá!%20Gostaria%20de%20mais%20informações%20sobre%20os%20serviços%20da%20Recupera%20Assistência%20Técnica.', '_blank');
  };
  ...
  return (
    <button
      ...
      className={`fixed bottom-6 right-6 z-50 flex items-center justify-center w-16 h-16 rounded-full shadow-xl transition-all duration-500 
        ...
        hover:scale-110 hover:shadow-2xl bg-green-500 hover:bg-green-600`}
      style={{
