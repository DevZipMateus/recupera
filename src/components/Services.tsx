    ...
    <section id="services" ref={sectionRef} className="py-16 sm:py-20 lg:py-24 xl:py-28 bg-white relative">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 2xl:px-16">
        <div className="text-center mb-12 sm:mb-16 lg:mb-20">
          ...
          >
            Mais de 15 anos de experiência cuidando dos dispositivos móveis e computadores 
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-12 mb-12 sm:mb-16 max-w-4xl mx-auto">
          {services.map((service, index) => (
            <div 
              ...
              className={cn(
                "relative bg-white rounded-xl sm:rounded-2xl p-6 sm:p-8 lg:p-10 shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 opacity-0 border-2",
                service.popular 
            ...
            >
              {service.popular && (
                <div className="absolute -top-3 sm:-top-4 left-1/2 transform -translate-x-1/2 bg-red-600 text-white px-3 sm:px-4 py-1 sm:py-1.5 rounded-full text-xs sm:text-sm font-bold">
                  MAIS PROCURADO
                </div>
              )}

              <div className={cn(
                "w-20 h-20 sm:w-24 sm:h-24 lg:w-28 lg:h-28 rounded-xl flex items-center justify-center mb-6 sm:mb-8 mx-auto",
                service.popular 
              ...
              <button 
                className={cn(
                  "w-full py-3 sm:py-4 rounded-lg font-bold transition-all duration-300 transform hover:scale-105 text-sm sm:text-base",
                  service.popular
